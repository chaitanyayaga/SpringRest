...
public class HelloWorldController {
	...
	public String helloWorldInternationalization(@RequestHeader(name="Acccept-Language", required=false) Locale locale) {
		//en = helloworld
	...
	public String helloWorldInternationalization2() {
		//en = helloworld
		return messageSource.getMessage("good.morning.message", null, 
